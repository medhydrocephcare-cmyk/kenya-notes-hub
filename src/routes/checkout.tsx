    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border/60 bg-surface/60">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-4 px-4 py-2.5 text-[11px] font-medium text-muted-foreground sm:text-xs">
          ...
          <span className="inline-flex items-center gap-1.5"><ShieldCheck className="h-3.5 w-3.5 text-brand" /> PCI-DSS compliant payments</span>
          <span className="text-border">•</span>
          <span className="inline-flex items-center gap-1.5"><CreditCard className="h-3.5 w-3.5 text-brand" /> M-Pesa · Visa · Mastercard</span>
        </div>
      </div>
                ...
                <div className="mt-4 rounded-xl border border-brand/30 bg-brand/5 p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">You'll get a payment prompt on your phone.</div>
                    </div>
                    <div className="ml-auto text-[10px] font-black uppercase tracking-wider text-emerald-700">Default</div>
                  </div>
                </div>
                <div className="mt-3 flex flex-wrap items-center gap-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                  <span className="rounded bg-emerald-600 px-2 py-1 text-white">M-PESA</span>
                  <span className="rounded bg-blue-600 px-2 py-1 text-white">VISA</span>
                  <span className="rounded bg-orange-500 px-2 py-1 text-white">MASTERCARD</span>
                  <span className="rounded bg-slate-700 px-2 py-1 text-white">BANK</span>
                </div>
              </Card>
            </div>
